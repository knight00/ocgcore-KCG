...
public:
	...
	static int32_t effect_get_target_range(lua_State *L);
	...
	static int32_t card_get_set_card(lua_State* L);
	static int32_t card_get_origin_set_card(lua_State* L);
	static int32_t card_get_pre_set_card(lua_State* L);
	...
	static int32_t card_get_free_linked_zone(lua_State* L);
	...
	static int32_t card_is_linked(lua_State* L);
	static int32_t card_is_extra_linked(lua_State* L);
	...
	static int32_t card_set_reason_card(lua_State* L);
	static int32_t card_set_reason_player(lua_State* L);
	static int32_t card_set_reason_effect(lua_State* L);
	...
	////////kdiy///////////	
	static int32_t card_is_otype(lua_State* L);
	////////kdiy///////////	
	...
	static int32_t card_is_gemini_state(lua_State* L);
	static int32_t card_enable_gemini_state(lua_State* L);
	...
	static int32_t card_get_card_effect(lua_State* L);
	...
	static int32_t card_enable_unsummonable(lua_State* L);
	...
	static int32_t card_is_procedure_summonable(lua_State* L);
	...
	static int32_t card_can_attack(lua_State* L);
	static int32_t card_can_chain_attack(lua_State* L);
	...
	static int32_t card_remove_all_counters(lua_State* L);
	static int32_t card_get_counter(lua_State* L);
	static int32_t card_get_all_counters(lua_State* L);
	static int32_t card_has_counters(lua_State* L);
	...
	static int32_t card_is_can_be_material(lua_State* L);
	...
	static int32_t card_add_monster_attribute_complete(lua_State* L);
	...
	static int32_t card_code(lua_State* L);
	static int32_t card_alias(lua_State* L);
	static int32_t card_setcode(lua_State* L);
	static int32_t card_type(lua_State* L);
	static int32_t card_level(lua_State* L);
	static int32_t card_attribute(lua_State* L);
	static int32_t card_race(lua_State* L);
	static int32_t card_attack(lua_State* L);
	static int32_t card_defense(lua_State* L);
	static int32_t card_rscale(lua_State* L);
	static int32_t card_lscale(lua_State* L);
	static int32_t card_link_marker(lua_State* L);
	static int32_t card_recreate(lua_State* L);
	static int32_t card_cover(lua_State* L);
	...
	static int32_t effect_get_reset(lua_State* L);
	...
	static int32_t group_take_at_pos(lua_State* L);
	static int32_t group_get_count(lua_State* L);
	static int32_t group_filter(lua_State* L);
	static int32_t group_filter_in_place(lua_State* L);
	...
	static int32_t group_get_class(lua_State* L);
	...
	static int32_t group_split(lua_State* L);
	static int32_t group_includes(lua_State* L);
	static int32_t group_get_bin_class_count(lua_State* L);
	static int32_t group_band(lua_State* L);
	static int32_t group_add(lua_State* L);
	static int32_t group_sub_const(lua_State* L);
	static int32_t group_len(lua_State* L);
	static int32_t group_equal_size(lua_State* L);
	static int32_t group_less_than(lua_State* L);
	static int32_t group_less_equal_than(lua_State* L);
	...
	static int32_t duel_procedure_summon(lua_State* L);
	static int32_t duel_pendulum_summon(lua_State* L);
	static int32_t duel_procedure_summon_group(lua_State* L);
	...
	static int32_t duel_sendto(lua_State* L);
	static int32_t duel_remove_cards(lua_State* L);
	...
	static int32_t duel_sort_deckbottom(lua_State* L);
	...
	static int32_t duel_get_environment(lua_State* L);
	...
	static int32_t duel_attack_cost_paid(lua_State* L);
	static int32_t duel_force_attack(lua_State* L);
	...
	static int32_t duel_get_free_linked_zone(lua_State* L);
	...
	static int32_t duel_is_attack_cost_paid(lua_State* L);
	...
	static int32_t duel_select_cards_code(lua_State* L);
	...
	static int32_t duel_set_possible_operation_info(lua_State* L);
	static int32_t duel_get_possible_operation_info(lua_State* L);
	...
	static int32_t duel_select_field_zone(lua_State* L);
	...
	static int32_t duel_is_duel_type(lua_State* L);
	static int32_t duel_is_player_affected_by_effect(lua_State* L);
	static int32_t duel_get_player_effect(lua_State* L);
	...
	static int32_t duel_can_player_set_monster(lua_State* L);
	static int32_t duel_can_player_set_spell_trap(lua_State* L);
	...
	static int32_t duel_is_player_can_pendulum_summon(lua_State* L);
	static int32_t duel_is_player_can_procedure_summon_group(lua_State* L);
	...
	static int32_t duel_assume_reset(lua_State* L);
	static int32_t duel_get_card_from_cardid(lua_State* L);
	static int32_t duel_load_script(lua_State* L);

	static int32_t duel_tag_swap(lua_State* L);
	static int32_t duel_get_player_count(lua_State* L);
	static int32_t duel_swap_deck_and_grave(lua_State* L);
	static int32_t duel_majestic_copy(lua_State* L);
	static int32_t duel_get_starting_hand(lua_State* L);
	...
	static int32_t debug_print_stacktrace(lua_State* L);
	//////kdiy/////
	static int32_t duel_bat(lua_State* L);
	//////kdiy/////
};
