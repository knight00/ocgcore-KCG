...
public:
	...
	int32_t check_event_c(effect* peffect, uint8_t playerid, int32_t neglect_con, int32_t neglect_cost, int32_t copy_info, tevent* pe = nullptr, bool modify_eff = false);
	/////kdiy///////////////
