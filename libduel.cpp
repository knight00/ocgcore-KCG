...
///kdiy/////////////////////
int32_t duel_get_master_rule(lua_State * L) {
...
int32_t duel_read_card(lua_State *L) {
...
int32_t duel_exile(lua_State *L) {
...
int32_t duel_setmetatable(lua_State *L) {
	check_param_count(L, 2);
...
int32_t duel_move_turn_count(lua_State *L) {
	const auto pduel = lua_get<duel*>(L);
...
int32_t duel_get_cards_in_zone(lua_State *L) {
	check_param_count(L, 2);
...
static constexpr luaL_Reg duellib[] = {
	///kdiy/////////
	{ "GetMasterRule", duel_get_master_rule },
	{ "ReadCard", duel_read_card },
	{ "Exile", duel_exile },
	{ "SetMetatable", duel_setmetatable },
	{ "MoveTurnCount", duel_move_turn_count },
	{ "GetCardsInZone", duel_get_cards_in_zone },	
    ///kdiy/////////
